...
%For forcing images onto particular pages:
\usepackage{float}

%For multiple rows in a table:
\usepackage{multirow}
...
\title{\huge {\textbf{General Tech Training}}} % Article title
...
\abstract{
This is the handout for the \textbf{General Tech Training}. It contains several important concepts that will help you to form/extend a solid technical knowledge basis. \\ 
}
 \end{@twocolumnfalse}
]
...
%Leave some blank space for aesthetics:
\vspace{5mm}
